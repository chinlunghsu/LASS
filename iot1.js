...
{
    //設定值
    deviceId: "XXX_XXXX",//your device id
    lat : XX.XXX,//查詢google
    lng : XXX.XXXX,// 查詢google
...
function loop(){//每當收到感測訊息
    ...
    //組出完整MQTT訊息
    var sFullData = "|ver_format=3|FAKE_GPS=1|fmt_opt=0|app=PM25|ver_app=0.7.13|device=Linkit7688duo"+ 
        "|device_id=" + global.deviceId + global.gpsstr +
        "|gps_fix=1|gps_num=1|gps_alt=1"
